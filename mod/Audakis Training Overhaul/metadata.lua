return PlaceObj('ModDef', {
	...
	'last_changes', "- Made Skills 90-100 progressively harder to get in Field Experience\n- Added 4 new Stat Gaining Prerequisites:\n- Scout Sector can roll WIS\n- Harvest Junk can roll MEC\n- Pick a door with lockpick can roll MEC\n- Break a door with crowbar can roll STR",
	'dependencies', {},
	'id', "audaAto",
	'author', "Audaki_ra",
	'version_major', 2,
