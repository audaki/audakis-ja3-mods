...
SquadBag.inventory_slots[1].width = 6
SquadBag.inventory_slots[1].large_with = 8

UnitInventory.inventory_slots[1].width = 8

SectorStash.inventory_slots[1].width = 6
VirtualSectorStash.inventory_slots[1].width = 6
...
local tile_size_rollover2 = 77
local scale_point = point(700, 700)
...
UndefineClass("XInventoryTile")
DefineClass.XInventoryTile = {
  __parents = {
    "XHoldButtonControl"
  },
  MinWidth = tile_size_rollover2,
  MaxWidth = tile_size_rollover2,
  MinHeight = tile_size_rollover2,
  MaxHeight = tile_size_rollover2,
  ImageFit = "width",
  slot_image = false,
...
function XInventoryItem:Init()
  ...
  item_pad:SetImageScale(scale_point)
  ...
  --item_img:SetImageScale(scale_point)
...
function XInventoryItem:OnContextUpdate(item, ...)
  ...
  self:SetMinWidth(tile_size2 * w)
  self:SetMaxWidth(tile_size2 * w)
  self:SetMinHeight(tile_size2 * h)
  self:SetMaxHeight(tile_size2 * h)
  self:SetGridWidth(w)
...
function XInventorySlot:SpawnDropUI(width, height, left, top)
  ...
  item_wnd:SetMinWidth(tile_size_rollover2 * width)
  item_wnd:SetMaxWidth(tile_size_rollover2 * width)
  item_wnd:SetMinHeight(tile_size_rollover2 * height)
  item_wnd:SetMaxHeight(tile_size_rollover2 * height)
  ...
  rollover_image:SetImageScale(scale_point)
...
UndefineClass("BrowseInventorySlot")
...
UndefineClass("EquipInventorySlot")
...
--UndefineClass("VirtualSectorStash")
...
UndefineClass("CombineItemPopupClass")
